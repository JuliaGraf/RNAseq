...
In a second process, Salmon is used to index the reference transcripts generated by RSEM. The indexed reference transcripts, along with the sample reads, are used by Salmon to produce transcript abundance tables in the third process of the alignment subworkflow.
